...
#ifndef __AI_WAVMODEL_H__
#define __AI_WAVMODEL_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_WAVMODEL_MODEL_NAME          "wavmodel"

#define AI_WAVMODEL_ACTIVATIONS_ALIGNMENT   (4)

#define AI_WAVMODEL_IN_NUM       (1)
#define AI_WAVMODEL_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 26, 167, 1, 1, NULL), \
}
#define AI_WAVMODEL_IN_SIZE { \
  (26 * 167 * 1), \
}
#define AI_WAVMODEL_IN_1_SIZE  (26 * 167 * 1)
#define AI_WAVMODEL_IN_1_SIZE_BYTES  ((26 * 167 * 1) * 4)





#define AI_WAVMODEL_OUT_NUM      (1)
#define AI_WAVMODEL_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 3, 1, NULL), \
}
#define AI_WAVMODEL_OUT_SIZE { \
  (1 * 1 * 3), \
}
#define AI_WAVMODEL_OUT_1_SIZE  (1 * 1 * 3)
#define AI_WAVMODEL_OUT_1_SIZE_BYTES  ((1 * 1 * 3) * 4)

#define AI_WAVMODEL_N_NODES (6)
 ...
 * @ref ai_wavmodel_create. Both the activations memory buffer 
 ...
 * using @ref ai_wavmodel_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_WAVMODEL_*
 * defines into file @ref wavmodel.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_wavmodel_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_WAVMODEL_H__*/
